...
//		Usuario usuario1 = new Usuario("fulando");
//		Usuario usuario2 = new Usuario("beltrano");
//		
//		lance10 = new Lance(usuario1, new BigDecimal("10.0"));
...
//	}
	...
	@Entao("o lance nao he aceito")
	public void o_lance_nao_he_aceito() {
	...
	@Entao("o segundo lance nao he aceito")
	public void o_segundo_lance_nao_he_aceito() {
		Assert.assertEquals(1, leilao.getLances().size());
